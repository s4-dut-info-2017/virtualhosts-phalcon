...
class STypeController extends ControllerBase{
	...
	public function editAction($id){
		...
		$formStype->fieldAsMessage(0,["icon"=>"edit","attached"=>true]);
		$formStype->fieldAsInput(2,["rules"=>"empty"]);
		$formStype->fieldAsInput("id",["inputType"=>"hidden"]);
		$formStype->fieldAsTextarea("configTemplate",["rows"=>4]);
		...
		$formStype->addWrapper(0,null,"<div class='ui attached segment'>");
		$formStype->addWrapper(3, null,"</div>");
